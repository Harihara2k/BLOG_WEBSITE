...
define('DB_USER', "id22187033_root"); // db user
define('DB_PASSWORD', "Hariharan@2k1212"); // db password (mention your db password here)
define('DB_DATABASE', "id22187033_collegeporatal"); // database name
...
<body>
    <nav>
        <img id="logo" src="https://upload.wikimedia.org/wikipedia/en/2/2a/Annamalai_University_logo.png" alt="">
        <img id="header" src="backg.jpg" alt="university_header">
